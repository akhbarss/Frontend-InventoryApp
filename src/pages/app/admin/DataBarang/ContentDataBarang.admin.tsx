...
import { columnsDataBarangAdmin } from "@utils/columns/data-barang.column";
import { useAuth } from "@utils/hooks/useAuth";
import usePagination from "@utils/hooks/usePagination";
import { CategoryItem } from "@utils/types/items.type";
import React, { useMemo } from "react";
import { StringParam, useQueryParam } from "use-query-params";
import { ModalDataBarang } from "./ModalDataBarang.admin";
  ...
  return (
    <PageContent>
      ...
      <CustomTable
        ...
        columns={columnsDataBarangAdmin(categoryItem)}
        totalPage={data?.payload?.meta.pageCount!}
      />
      {paginations}
      {modal}
